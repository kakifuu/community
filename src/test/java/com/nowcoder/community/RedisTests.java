...
public class RedisTests {
    ...
    public void testSortedSet() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "小暗", 40);
        redisTemplate.opsForZSet().add(redisKey, "小白", 70);
        redisTemplate.opsForZSet().add(redisKey, "小黑", 50);
        redisTemplate.opsForZSet().add(redisKey, "小小", 90);

        System.out.println(redisTemplate.opsForZSet().zCard(redisKey));
        System.out.println(redisTemplate.opsForZSet().score(redisKey, "小明"));
        System.out.println(redisTemplate.opsForZSet().reverseRank(redisKey, "小明"));
